  ...
  <main class="container">
    ...
    <section id="overtime-section" class="mt-5">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Overtime</h2>
        <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#filterOvertimeModal"><i class="bi bi-funnel me-2"></i>Filter employees</button>
      </div>
      ...
      <!-- filterOvertimeModal -->
      <div class="modal fade" id="filterOvertimeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="filterOvertimeModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="staticBackdropLabel">Filter employee</h1>
